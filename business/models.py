...
from utils.basemodels import CreateUpdate


class BusinessAccountInfo(CreateUpdate):
    """ 出题帐户类 """
...
class BusinessAppInfo(CreateUpdate):
    """ 应用信息类 """
...
class AppConfigInfo(CreateUpdate):
    """ 应用配置信息类 """
...
class UserInfoImage(CreateUpdate):
    """
    用户表单图片配置类
    """
...
class UserInfoRegex(CreateUpdate):
    """
    用户正则表达式配置类
    """
