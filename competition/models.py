...
from utils.basemodels import CreateUpdate, MediaMixin


class CompetitionKindInfo(CreateUpdate):
    """比赛类别信息类"""
...
class ChoiceInfo(CreateUpdate, MediaMixin):
    """
    选择题信息类
    """
...
class FillInBlankInfo(CreateUpdate, MediaMixin):
    """
    填空题信息类
    """
...
class CompetitionQAInfo(CreateUpdate):
    """答题记录信息类"""
